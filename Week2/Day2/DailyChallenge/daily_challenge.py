...
# The second argument (pageSize) could be a float, in that case just convert it to an int
# (this is also the case for the goToPage method)
...
# (e.g. there are only 5 total pages, but p.goToPage(10) is given: the p.currentPage should be set to 5; if 0 or a negative number
# is given, p.currentPage should be set to 1).
